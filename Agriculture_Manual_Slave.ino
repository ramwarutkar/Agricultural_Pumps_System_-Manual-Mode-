...
void saving_data()
{
  ...
  { //  (Pattern - EEPROM - 84 = pattern_days || EEPROM - 85 = pattern_alternate || EEPROM - 86 = pattern_for)
    ...
    if (pattern_days == 1)
    {
      ...
      EEPROM.write(9, on_sec); EEPROM.write(10, on_min); EEPROM.write(11, on_hour); // Off Time EEPROM Save
  ...
  { //  (Pattern - EEPROM - 87 = pattern_days || EEPROM - 88 = pattern_alternate || EEPROM - 89 = pattern_for)
    ...
    if (pattern_days == 1)
    {
      ...
      EEPROM.write(22, on_sec); EEPROM.write(23, on_min); EEPROM.write(24, on_hour); // Off Time EEPROM Save
  ...
  { //  (Pattern - EEPROM - 90 = pattern_days || EEPROM - 91 = pattern_alternate || EEPROM - 92 = pattern_for)
    ...
    if (pattern_days = 1)
    {
      ...
      EEPROM.write(35, on_sec); EEPROM.write(36, on_min); EEPROM.write(37, on_hour); // Off Time EEPROM Save
  ...
  { //  (Pattern - EEPROM - 93 = pattern_days || EEPROM - 94 = pattern_alternate || EEPROM - 95 = pattern_for)
    ...
    if (pattern_days = 1)
    {
      ...
      EEPROM.write(48, on_sec); EEPROM.write(49, on_min); EEPROM.write(50, on_hour); // Off Time EEPROM Save
  ...
  { //  (Pattern - EEPROM - 96 = pattern_days || EEPROM - 97 = pattern_alternate || EEPROM - 98 = pattern_for)
    ...
    if (pattern_days = 1)
    {
      ...
      EEPROM.write(61, on_sec); EEPROM.write(62, on_min); EEPROM.write(63, on_hour); // Off Time EEPROM Save
  ...
  { //  (Pattern - EEPROM - 99 = pattern_days || EEPROM - 100 = pattern_alternate || EEPROM - 101 = pattern_for)
    ...
    if (pattern_days = 1)
    {
      ...
      EEPROM.write(74, on_sec); EEPROM.write(75, on_min); EEPROM.write(76, on_hour); // Off Time EEPROM Save
